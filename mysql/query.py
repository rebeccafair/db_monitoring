...
last_names = [line.strip() for line in open('db_entries/last_names.txt')]
dept_names = [line.strip() for line in open('db_entries/dept_names.txt')]
titles = [line.strip() for line in open('db_entries/titles.txt')]
