...
#sudo cp db.php /etc/cacti/
#sudo cp cacti.conf /etc/httpd/conf.d/
#(sudo crontab -l ; echo "*/5 * * * *     root   /usr/bin/php /usr/share/cacti/poller.php > /dev/null 2>&1") | sudo crontab -
#sudo chown -R root /usr/share/cacti/rra /usr/share/cacti/log
