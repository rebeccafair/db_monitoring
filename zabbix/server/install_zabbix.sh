...
# Enable email alerts through via gmail for Zabbix. See http://www.catonrug.net/2015/12/send-mail-through-smtp-gmail-server-from-zabbix.html
sudo cp zabbix-alert-smtp.py /usr/lib/zabbix/alertscripts
